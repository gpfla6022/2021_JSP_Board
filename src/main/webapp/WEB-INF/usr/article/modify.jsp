						...
						<div class="form-control">
							...
							<div>
								<input class="input input-bordered w-full" type="text"
									name="title" maxlength="100" placeholder="제목을 입력해주세요." value = ${article.title}  />
							</div>
						</div>
						<div class="form-control">
							<label class="label">
							...
							<textarea maxlength="2000"
								...
								placeholder="내용을 입력해 주세요." name="body" value = ${article.body}></textarea>
						</div>
						<div class="btns">
							<button type="submit" class="btn btn-ghost">수정</button>
							<button  onclick = "history.back();" type="button" class="btn btn-ghost">수정취소</button>
						</div>
					</form>
				</div>
			</div>
